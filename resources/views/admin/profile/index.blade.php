                ...
                <div class="card-body">
                  ...
                  <div class="tab-content">
                    <div class="active tab-pane" id="activity">
                      <form class="form-horizontal" method="POST" action="{{ route('admin#updateProfile',$admin->id) }}">
                        @csrf
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                            <input type="number" class="form-control" name="phone" value="{{ old('phone',$admin->phone) }}" placeholder="Phone Number">
                            @if ($errors->has('phone'))
