              ...
              <div class="card-header">
                <h3 class="card-title">
                    <a href="{{ route('admin#createPizza') }}">
                        <button type="text" class="btn btn-sm btn-dark text-white mt-1">
                            <i class="fa-solid fa-plus"></i>
                        </button>
                    </a>
                </h3>
                <span class="fs-5 ml-2">Total - {{ $pizza->total() }} </span> {{-- total() is from paginate --}}
                  ...
                  <tbody>
                   ...
                   @else
                        ...
                        <tr>
                            ...
                            <a href="{{ route('admin#pizzaInfo',$item->pizza_id) }}"> <button class="btn btn-sm bg-primary text-white" title="See More"><i class="fa-solid fa-eye"></i></button></a>
                            </td>
                        </tr>
                        @endforeach
                   @endif
