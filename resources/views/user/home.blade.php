    ...
    <div class="container px-4 px-lg-5" id="home">
        ...
        <div class="d-flex">
            ...
            <div class="mt-5">
                        ...
                        <div class="col-4 mb-5">
                            <div class="card h-100" style="width:200px">
                                ...
                                <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                    <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="{{ route('user#pizzaDatails',$item->pizza_id) }}">More Details</a></div>
                                </div>
                            </div>
                        </div>
                    @endforeach
                ...
                @else
                    <div class="alert alert-danger" style="width:500px; margin-top:50px" role="alert">
                        There is no pizza
                    </div>
                @endif
                {{ $pizza->links() }}
